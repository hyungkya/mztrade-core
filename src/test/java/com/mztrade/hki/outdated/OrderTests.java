...
public class OrderTests {
    ...
    void simpleBuyTest() {
        ...
        orderService.buy(1, "000270", Instant.parse(Util.formatDate("20150105")), 3);
        orderService.buy(1, "000270", Instant.parse(Util.formatDate("20150112")), 3);
        orderService.buy(1, "000270", Instant.parse(Util.formatDate("20150119")), 3);
        ...
        orderService.sell(1, "000270", Instant.parse(Util.formatDate("201501230")), 9);
