...
CREATE TABLE hkidb.user (
                           uid         INT         NOT NULL    AUTO_INCREMENT  PRIMARY KEY,
                           name        VARCHAR(30) NOT NULL    UNIQUE,
                           password    VARCHAR(30) NOT NULL
);

INSERT INTO hkidb.user (name, password) VALUES ('ADMIN', 'ADMIN');
...
INSERT INTO hkidb.order_type (otid, name) VALUES (1, 'BUY'),
                                                (2, 'SELL');
...
CREATE TABLE hkidb.account (
                              ...
                              FOREIGN KEY (uid) REFERENCES hkidb.user (uid)
);
