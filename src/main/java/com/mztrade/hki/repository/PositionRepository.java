...
public class PositionRepository {
    ...
    @Autowired
    public PositionRepository(NamedParameterJdbcTemplate template, ObjectMapper objectMapper) {
            ...
            return this.template.queryForObject(
                    ...
                    (rs, rowNum) ->
                            Optional.of(
                                    ...
                                    .setAid(aid)
                                    .setTicker(ticker)
                                    .setQty(rs.getInt("p.qty"))
                                    .setAvgEntryPrice(rs.getBigDecimal("p.avg_entry_price"))
                            )
            );
