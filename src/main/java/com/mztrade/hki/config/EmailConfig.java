...
public class EmailConfig {
    @Bean
    public JavaMailSender mailSender(@Value("${smtp.key}") String SMTP_KEY) {//JAVA MAILSENDER 인터페이스를 구현한 객체를 빈으로 등록하기 위함.
        ...
        mailSender.setUsername("mztrade.dev@gmail.com");//구글계정을 넣습니다.
        mailSender.setPassword(SMTP_KEY);//구글 앱 비밀번호를 넣습니다.
